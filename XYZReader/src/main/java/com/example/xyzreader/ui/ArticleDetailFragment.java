...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        final TextView articleTitleLand = mRootView.findViewById(R.id.article_title);
        ...
        if (getActivity() != null) {
            Glide.with(getActivity().getApplicationContext())
                    ...
                    .listener(new RequestListener<Bitmap>() {
                        ...
                        @Override
                        public boolean onResourceReady(Bitmap resource, Object model, Target<Bitmap> target, boolean isFirtResource) {
