...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.ViewHolder> {
    ...
    public ArticleAdapter(Cursor mCursor, ArticleListActivity mIArticleItemClickListener) {

        this.mCursor = mCursor;
        this.mIArticleItemClickListener = (IArticleItemClickListener) mIArticleItemClickListener;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final ArticleListActivity.ViewHolder holder, int position) {
        ...
        ViewCompat.setTransitionName(holder.thumbnailView, "article-thumbnail" + holder.getAdapterPosition());
